...
const VARIANTS = [
  { key: "A", label: "Full session form" },
  { key: "B", label: "One-exercise-at-a-time wizard" },
  { key: "C", label: "Dense spreadsheet table" },
  { key: "D", label: "Full session form, simplified (synthesis)" },
] as const;
