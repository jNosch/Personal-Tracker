...
// PROTOTYPE INFRA — floating variant switcher, shared by all prototype routes.
...
const VARIANTS = [
  { key: "A", label: "Dashboard grid" },
  { key: "B", label: "Sidebar + focused chart" },
  { key: "C", label: "Combined overlay" },
  { key: "D", label: "Combined overlay + time range (synthesis)" },
] as const;
